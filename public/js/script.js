...
class ArrowPointer {
    constructor() {
      ...
      this.cursorStyle = {
        ...
        transition: '250ms, transform 56ms',
        userSelect: 'none',
        pointerEvents: 'none'
      }
...
const myDiv = document.querySelector(".grid-liens");
const myRange = document.querySelector("#myRange");

myRange.addEventListener("input", () => {
  const angle = myRange.value;
  myDiv.style.transform = `translate(-50%, -50%) rotate(${angle}deg)`;
});
